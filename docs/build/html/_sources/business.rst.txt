...
Clase `HandlerBranchBusiness`
----------------------------------------------------

.. autoclass:: HandlerBranchBusiness
   :members:
   :undoc-members:
   :show-inheritance:

Función Principal `process_latest_staging()`
------------------------------------------------------

.. autofunction:: business.HandlerBranchBusiness.process_latest_staging 
   :no-index:
...
- `business/`: Directorio donde se almacenan los datos modificados en formato Parquet.
